...
def get_operator_prompt(seed: int) -> str:
    """
...
def build_system_prompt() -> dict[str, str]:
    ...
    operator_description = "Operator: SomeNumber, Type: Binary"
...
You are also provided a list of operators. There are unary and binary operators. Unary operators \
...
def build_user_prompt(dataset: Dataset,
    ...
    operator_template = get_operator_prompt(seed=seed)
...
def build_feature_from_string(X: pd.DataFrame,
    ...
    operator_mapping = {
        ...
        "Thirteen": "Divide",
        "Fourteen": "Combine",
        "Fifteen": "CombineThenFrequencyEncoding",
        "Sixteen": "GroupByThenMin",
        "Seventeen": "GroupByThenMax",
        "Eighteen": "GroupByThenMean",
        "Nineteen": "GroupByThenMedian",
        "Twenty": "GroupByThenStd",
        "Twentyone": "GroupByThenRank"
    }
