...
from llmbias.generators.blueprint.core import build_assistant_prompt, \
...
tokens. Results are probably useless.")
    ...
    def _generate(self,
        ...
        :param max_tokens: The maximum number of tokens the model is allowed to
            generate.
        :param prompt_type: The type of prompt that is currently used. Options
            are "base" and "blind_operator".
        Returns
        ...
        while retries < self.max_retries:
            logger.info(f"Using {prompt_type} prompt type for prompt generation")
